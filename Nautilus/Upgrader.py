...
class Upgrader:
    ...
    def diffMaker(self):
        ...
        oldQuals = set(self.fileList(os.path.join(Resources.getStoragePath(Resources.Resources),"quality","nautilusquals","hr_nautilus")))
    ...
    def configFixer(self):
        ...
        for qual in dQuals:
            Logger.log("i","update this quality: ",qual)
