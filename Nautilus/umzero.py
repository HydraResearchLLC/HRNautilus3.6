...
class ZeroConfClient:
    ...
    ZERO_CONF_NAME = u"hydraresearchna._http._tcp.local."
    ...
    def start(self) -> None:
        ...
        # CURA-6855 catch WinErrors
            ...
            Logger.logException("e", "HRN Failed to create zeroconf instance.")
            return
        ...
        while True:
            ...
            while not self._service_changed_request_queue.empty():
                ...
                try:
                    ...
                    Logger.logException("e", "HRN Failed to get service info for [%s] [%s], the request will be rescheduled",
                                        service_type, name)
                    reschedule_requests.append(request)
        ...
        if info:
            ...
            if type_of_device:
                if type_of_device == b"printer":
                    ...
                    Logger.log("w", "HRN The type of the found device is '%s', not 'printer'." % type_of_device)
        else:
            Logger.log("w", "HRN Could not get information about %s" % name)
            return False
    ...
    def _onServiceRemoved(self, name: str) -> bool:
        Logger.log("d", " HRN ZeroConf service removed: %s" % name)
