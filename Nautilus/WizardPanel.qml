...
Item
{
    ...
    property var crntItem: (model == null) ? null : model.getItem(model.crntPageIndex)
    property var model: null

    // Convenience properties
    property var progressValue: model == null ? 0 : model.crntProgress
    property string pageUrl: crntItem == null ? "" : crntItem.HRpage_url
