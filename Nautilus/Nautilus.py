...
from . import HydraWelcome
from cura.CuraApplication import CuraApplication

from PyQt5.QtWidgets import QApplication, QFileDialog
from PyQt5.QtGui import QPixmap, QScreen, QColor, qRgb, QImageReader, QImage, QDesktopServices
from PyQt5.QtCore import QByteArray, QBuffer, QIODevice, QRect, Qt, QSize, pyqtSlot, QObject, QUrl, pyqtProperty, QTimer
...
class Nautilus(QObject, MeshWriter, Extension):
    ...
    def __init__(self):
        ...
        try:
            ...
            Logger.log("i","Could not connect to GitHub, don't show firmware message")
            self.fullJson = None
        ...
        self._application.initializationFinished.connect(self.createthewindow)

    def createthewindow(self):
        _welcome_timer = QTimer(self)
        _welcome_timer.setInterval(2000)
        _welcome_timer.setSingleShot(True)
        _welcome_timer.timeout.connect(self.welcome)
        _welcome_timer.start()
