...
Item
{
    ...
    propert var duetmodel: NautilusDuet;
    ...
    Row {
        ...
        Button {
            ...
            onClicked: {
                ...
                instanceDialog.url = duetmodel.instanceUrl(dialog.currentName);
                instanceDialog.duet_password = duetmodel.instanceDuetPassword(dialog.currentName);
                instanceDialog.http_user = duetmodel.instanceHTTPUser(dialog.currentName);
                instanceDialog.http_password = duetmodel.instanceHTTPPassword(dialog.currentName);
                instanceDialog.open();
                nameField.textChanged();
            }
        }
    ...
    Item {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Text { font.bold: true; text: duetmodel.instanceUrl(dialog.currentName); }

                Label { text: catalog.i18nc("@label", "Nautilus Password"); }
                Text { font.bold: true; text: duetmodel.instanceDuetPassword(dialog.currentName); }

                Label { text: catalog.i18nc("@label", "HTTP Basic Auth: user"); }
                Text { font.bold: true; text: duetmodel.instanceHTTPUser(dialog.currentName); }

                Label { text: catalog.i18nc("@label", "HTTP Basic Auth: password"); }
                Text { font.bold: true; text: duetmodel.instanceHTTPPassword(dialog.currentName); }
            }
    ...
    Item {
        UM.Dialog {
            ...
            onAccepted: {
                duetmodel.saveInstance(oldName, nameField.text, urlField.text, duet_passwordField.text, http_userField.text, http_passwordField.text);
            ...
            Column {
                ...
                TextField {
                    ...
                    onTextChanged: {
                        instanceDialog.validName = duetmodel.validName(instanceDialog.oldName, nameField.text);
                    }
                }
                ...
                TextField {
                    ...
                    anchors.right: parent.right;
                    onTextChanged: {
                        instanceDialog.validUrl = duetmodel.validUrl(instanceDialog.oldName, urlField.text);
                    }
                }
